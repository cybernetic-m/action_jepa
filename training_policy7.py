...
if __name__ == '__main__':
    ...
    AGGREGATION_MODE_ACTOR = model_config['aggregation_mode_actor']
    AGGREGATION_MODE_REFINER = model_config['aggregation_mode_refiner']
    ...
    pre_trained_model = "results/policy/2026_06_26__15_38/best_model.pth"
    ...
    model_check = torch.load(pre_trained_model, map_location='cpu')
    checkpoint = model_check['model_state_dict']
