...
class TransformerActionJEPA(nn.Module):
    def __init__(self, 
        ...
        self.predictor = PredictorAC(model_path=vjepa_predictor_path, num_frames=self.num_frames, frozen=False, device=device, finetuned_pred = False)
    ...
    def forward(self, language_input, vision_input, joint_input):
        ...
        # REFINER
        refiner_context = torch.cat([z_obs_attention, z_pred_context, z_text_proj, z_joint_proj], dim=1)
